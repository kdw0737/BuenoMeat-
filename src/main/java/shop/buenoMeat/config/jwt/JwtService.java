...
public class JwtService {
    ...
    public String createAccessToken(String email) {
        ...
        log.info("Created Access Token for email: {}", email);
        log.info("accessToken 발급 완료");
        log.info("발급된 Token:{}", accessToken);
        return accessToken;
    }
    ...
    public void updateRefreshToken(String email, String refreshToken) {
        Optional<Member> findMember = Optional.ofNullable(memberRepository.findByEmail(email).get(0));
        findMember
                .ifPresentOrElse(
